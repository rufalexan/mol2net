...
#####################PREAMBLE
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
trafos          =       ['H2', 'O', 'CO', 'NH3'] #set of trafos #['H2','O','CO','NH3','CHN','H2O','CO2','CH2O','CHNO']
...
sample          =       'Sample'                   #previously 'Ice composition H2O_CH3OH_NH3' in anachem
nComponents     =       1
only_uniques    =       'yes'
color_type      =       sample
node_size       =       'Degree'
...
#
    ...
    print('\n\n\n\n')
    #
    FILTER_COMPONENTS  =        list(df_comp_freq_comb.index)[:nComponents] #you can select manually, we will automate this later, will have to discuss this with alex
