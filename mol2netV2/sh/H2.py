...
#####################PREAMBLE
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
trafos          =       ['CO','O','NH3'] #modified e-mail/why? #['H2','O','CO','NH3','CHN','H2O','CO2','CH2O','CHNO']
...
plt.savefig('NetworkRepresentation_clean_H2'+'.png')
...
for color_type in l:
    ...
    plt.axis('off')
    plt.savefig('fCSoff_Supporting Figure 7 - ' + color_type + '_minimal_set_H2_all_components' + '.pdf')
    plt.show()
...
plt.axis('off')
plt.savefig('fCSoff_Sum_of_Standard_Deviations_H2.pdf')
plt.show()
...
# Map the top 5 subgraphs to black color and update 'colored_subgraph' and 'colored_subgraph_component'
node_colors_top5 = ['black' if df_comp_freq in top5_subgraphs else 'gray' for df_comp_freq in xNODES['df_comp_freq']]
xNODES.loc[xNODES['df_comp_freq'].isin(top5_subgraphs), 'colored_subgraph'] = 'black'
...
plt.axis('off')
plt.savefig('Soff_Top_5_Subgraphs_with_Smallest_Std_Color_H2.pdf')
plt.show()
...
shades_of_orange = ['#B30378', '#E365CE', '#C17BC1', '#FF00D5', '#FF99CC'] #actually magenta now
...
plt.axis('off')
plt.savefig('fCSoff_Top_5_Subgraphs_with_Smallest_Std_H2.pdf')
plt.show()

fCxNODES_annotated4 = xNODES.copy()
fCxNODES_annotated4.to_csv("fCxNODES_annotated4.tsv")
xNODES.to_csv("Nodes_H2_Soff.tsv")
...
for comp in FILTER_COMPONENTS_filtered:
    ...
    plt.text(x-1000, y+100, text, fontsize=8, ha='left', va='center')
...
plt.legend()
plt.savefig('fc_S8_H2_Annotated_Soff_Range_Filtered_Filtered_v2' +'.pdf')
plt.show()
