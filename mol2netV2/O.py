...
#####################PREAMBLE
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
trafos          =       ['H2','CO','NH3'] #modified e-mail/why? #['H2','O','CO','NH3','CHN','H2O','CO2','CH2O','CHNO']
...
plt.savefig('NetworkRepresentation_clean_O'+'.png')
...
for color_type in l:
    ...
    plt.axis('off')
    plt.savefig('fCSoff_Supporting Figure 7 - ' + color_type + '_minimal_set_O_all_components' + '.pdf')
    plt.show()
...
plt.axis('off')
plt.savefig('fCSoff_Sum_of_Standard_Deviations_O.pdf')
plt.show()
...
#shades_of_orange = ['#008000', '#00B300', '#00CC66', '#00E673', '#00FFA6'] #actually green now
#53C78D,#93C572
shades_of_orange = ['#008000', '#00B300', '#00CC66', '#93C572', '#00FFA6'] #actually green now
...
plt.axis('off')
plt.savefig('fCSoff_Top_5_Subgraphs_with_Smallest_Std_O.png')
plt.show()
fCxNODES_annotated3 = xNODES.copy()#Saving the dataframes so you don't have to compile everything again if you want to change something 

fCxNODES_annotated3.to_csv("fCxNODES_annotated3.tsv")
xNODES.to_csv("Nodes_O_Soff.tsv")
...
plt.legend()
plt.savefig('fc_S8_O_Annotated_Soff_Range_Filtered_Filtered_v2' +'.pdf')
plt.show()
